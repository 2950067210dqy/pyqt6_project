...
class Tab_1(ThemedWidget):
    ...
    def _init_customize_ui(self):
        # 图表 左下布局
        frame_left_bottom: QVBoxLayout = self.findChild(QVBoxLayout, "frame2_contentlayout")
        ...
        # 图表 右边布局
        frame_right = self.findChild(QVBoxLayout, "frame3_contentlayout")
        # 添加滑动条区域
        # 创建滚动区域
    ...
    # 实例化自定义ui
    @logger.catch
    def _init_customize_ui_backup(self):
        # 图表 左下布局
        frame_left_bottom: QVBoxLayout = self.findChild(QVBoxLayout, "frame2_contentlayout")
