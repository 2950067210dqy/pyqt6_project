...
class Ui_tab2_frame(object):
    def setupUi(self, tab2_frame):
        ...
        self.export_alldata_btn = QtWidgets.QPushButton(parent=self.tab_1_layout_scroll_content)
        ...
        self.history_combox.addItem("")
        self.history_combox.addItem("")
        self.export_history_btn = QtWidgets.QPushButton(parent=self.tab_1_layout_scroll_content)
        ...
        self.export_history_detail_btn = QtWidgets.QPushButton(parent=self.tab_1_layout_scroll_content)
