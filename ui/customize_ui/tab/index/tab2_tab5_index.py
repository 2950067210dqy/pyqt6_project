...
from ui.customize_ui.tab.tab2_tab5 import Ui_tab_5_frame
from ui.tab7 import Ui_tab7_frame
from util.number_util import number_util


class Tab2_tab5(ThemedWidget):
    # 更新端口选择和鼠笼选择
    ...
    def _init_customize_ui(self):
        ...
        try:
            ...
            logger.error(f"tab_tab5_index图表创建错误：{e}")
        pass
        ...
        try:
            ...
            logger.error(f"tab_tab5_index table创建错误：{e}")
        pass
