...
class Tab2_tab0(ThemedWidget):
    ...
    def _init_customize_ui(self):
        ...
        #charts!
        try:
            self.now_data_chart_widget = LineChartWidget(type=self.type,object_name=f"{self.type.value['name']}_monitor_data_line_chart", data_type='monitor_data', mouse_cage_number=0,parent=self.now_data_layout)
