...
class Ui_tab_1_frame(object):
    ...
    def retranslateUi(self, tab_1_frame):
        ...
        self.nowdata_label.setText(_translate("tab_1_frame", "当前温度（℃）："))
        self.nowdata_trend_label.setText(_translate("tab_1_frame", "当前温度趋势"))
        self.history_label1.setText(_translate("tab_1_frame", "历史"))
        self.history_label2.setText(_translate("tab_1_frame", "温度趋势"))
        self.history_combox.setItemText(0, _translate("tab_1_frame", "7天"))
        self.history_combox.setItemText(1, _translate("tab_1_frame", "3天"))
        self.history_combox.setItemText(2, _translate("tab_1_frame", "1天"))
        self.history_detail_label.setText(_translate("tab_1_frame", "历史温度数据"))
        self.data_alarm.setText(_translate("tab_1_frame", "温度预警位"))
