...
class Ui_tab_3_frame(object):
    def setupUi(self, tab_3_frame):
        ...
        self.tab_3_layout_scroll.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        ...
        self.tab_3_layout_scroll_content.setGeometry(QtCore.QRect(0, 0, 897, 607))
        self.tab_3_layout_scroll_content.setObjectName("tab_3_layout_scroll_content")
        self.nowdata_label = QtWidgets.QLabel(parent=self.tab_3_layout_scroll_content)
        self.nowdata_label.setGeometry(QtCore.QRect(20, 50, 121, 31))
        self.nowdata_label.setObjectName("nowdata_label")
        self.nowdata_lcdnumber = QtWidgets.QLCDNumber(parent=self.tab_3_layout_scroll_content)
        ...
        self.nowdata_trend_label = QtWidgets.QLabel(parent=self.tab_3_layout_scroll_content)
        self.nowdata_trend_label.setGeometry(QtCore.QRect(280, 10, 81, 31))
        self.nowdata_trend_label.setObjectName("nowdata_trend_label")
        self.nowdata_trend_charts = QtWidgets.QGraphicsView(parent=self.tab_3_layout_scroll_content)
        ...
        self.export_alldata_btn = QtWidgets.QPushButton(parent=self.tab_3_layout_scroll_content)
        ...
        self.history_label1 = QtWidgets.QLabel(parent=self.tab_3_layout_scroll_content)
        self.history_label1.setGeometry(QtCore.QRect(20, 130, 31, 31))
        self.history_label1.setObjectName("history_label1")
        self.history_label2 = QtWidgets.QLabel(parent=self.tab_3_layout_scroll_content)
        self.history_label2.setGeometry(QtCore.QRect(170, 130, 51, 31))
        self.history_label2.setObjectName("history_label2")
        self.history_combox = QtWidgets.QComboBox(parent=self.tab_3_layout_scroll_content)
        ...
        self.history_combox.addItem("")
        self.history_combox.addItem("")
        self.export_history_btn = QtWidgets.QPushButton(parent=self.tab_3_layout_scroll_content)
        ...
        self.history_charts = QtWidgets.QGraphicsView(parent=self.tab_3_layout_scroll_content)
        ...
        self.history_detail_label = QtWidgets.QLabel(parent=self.tab_3_layout_scroll_content)
        ...
        self.history_detail_dateedit = QtWidgets.QDateEdit(parent=self.tab_3_layout_scroll_content)
        ...
        self.export_history_detail_btn = QtWidgets.QPushButton(parent=self.tab_3_layout_scroll_content)
        ...
        self.history_detail_charts = QtWidgets.QGraphicsView(parent=self.tab_3_layout_scroll_content)
        ...
        self.data_alarm = QtWidgets.QLabel(parent=self.tab_3_layout_scroll_content)
        self.data_alarm.setGeometry(QtCore.QRect(20, 10, 121, 31))
        self.data_alarm.setObjectName("data_alarm")
        self.detaildata_groupbox = QtWidgets.QGroupBox(parent=self.tab_3_layout_scroll_content)
    ...
    def retranslateUi(self, tab_3_frame):
        ...
        self.nowdata_label.setText(_translate("tab_3_frame", "当前温度（℃）："))
        self.nowdata_trend_label.setText(_translate("tab_3_frame", "当前温度趋势"))
        self.history_label1.setText(_translate("tab_3_frame", "历史"))
        self.history_label2.setText(_translate("tab_3_frame", "温度趋势"))
        self.history_combox.setItemText(0, _translate("tab_3_frame", "7天"))
        self.history_combox.setItemText(1, _translate("tab_3_frame", "3天"))
        self.history_combox.setItemText(2, _translate("tab_3_frame", "1天"))
        self.history_detail_label.setText(_translate("tab_3_frame", "历史温度数据"))
        self.data_alarm.setText(_translate("tab_3_frame", "温度预警位"))
        self.detaildata_groupbox.setTitle(_translate("tab_3_frame", "详细数据"))
