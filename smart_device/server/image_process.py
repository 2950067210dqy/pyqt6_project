...
class Img_process(Thread):
    ...
    def __init__(self, type, temp_folder, record_folder, report_file_path):
        ...
        self.path = global_setting.get_setting('smart_device_server_config')['Storage']['fold_path']
        # YL FL
        self.type = type
    ...
    def run(self):
        ...
        while (self.running):
            ...
            time.sleep(float(global_setting.get_setting("smart_device_server_config")['Image_Process']['delay']))
