...
from smart_device.index.tab import Tab
...
class AllWindows():
    ...
    def _init_ui(self):
        # 主窗口实例化
        geometry = QRect(0, 0, int(global_setting.get_setting("smart_device_configer")['WINDOW']['width']),
                         int(global_setting.get_setting("smart_device_configer")['WINDOW']['height']))
        self.mainWindow = Tab(parent=None, geometry=geometry,
                              title=global_setting.get_setting("smart_device_configer")['WINDOW']['title'], id=1)
